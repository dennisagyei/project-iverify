...
<table cellpadding=2 cellspacing=2 border=1 bgcolor=#efefef>
  ...
  <tr align=left valign=top>
    <td>5.</td>
    <td><b>Advanced:</b> this is the 'Hello World' demo, with the advanced usage</td>
    <td><a href="demo_advanced.php" target="_parent">[run&nbsp;code]</a></td>
    <td><a href="#" onclick="agent.call('','showcode','cb_showcode','demo_advanced.php')">
    [show&nbsp;code]</a></td>
  </tr>
  <tr align=left valign=top>
    <td>6.</td>
